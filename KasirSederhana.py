print("----------------- Selamat datang di Restogreen -----------------")
...
def makanan():
   ...
   global porsi
   global mkn
   print ("\n----------------- Menu Makanan Restogreen -----------------")
   print("1. Nasi Goreng : Rp 10000")
   print("2. Ayam Geprek + Ayam Kremes : Rp 15000")
   print("3. Mie Ayam : Rp 7000")
   ...
   if nomor==1:
       ...
       print (porsi," porsi Ayam Geprek + Ayam Kremes = Rp", totalmkn)
       mkn=("Ayam Geprek + Es Teh")
   elif nomor==3:
       totalmkn=porsi*7000
